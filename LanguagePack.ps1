...
function Patch-JsLanguage {
    ...
    $fallbackReplacements = [ordered]@{
        ...
        'defaultMessage:"New session",id:"Ajmo+3Cu3b"'    = 'defaultMessage:"新建会话",id:"Ajmo+3Cu3b"'
        'defaultMessage:"Recents",id:"wA4FIMmtlS"'        = 'defaultMessage:"最近",id:"wA4FIMmtlS"'
        'defaultMessage:"Sessions you start will show up here",id:"2QWN8hlND7"' = 'defaultMessage:"你启动的会话会显示在这里",id:"2QWN8hlND7"'
        'defaultMessage:"High",id:"AxMhQrcUDC"'           = 'defaultMessage:"高",id:"AxMhQrcUDC"'
        'defaultMessage:"High",id:"NqAztXFiG6"'           = 'defaultMessage:"高",id:"NqAztXFiG6"'
        'defaultMessage:"Bypass permissions",id:"PHx7oHc7eF"' = 'defaultMessage:"绕过权限",id:"PHx7oHc7eF"'
        'defaultMessage:"Describe what you want Code to do…",id:"n6hqGlQEYe"' = 'defaultMessage:"描述你想让 Code 做什么…",id:"n6hqGlQEYe"'
        'defaultMessage:"Local sessions",id:"SKeCK+7hmh"' = 'defaultMessage:"本地会话",id:"SKeCK+7hmh"'
        'defaultMessage:"Enable remote control by default",id:"akXG4ChYkN"' = 'defaultMessage:"默认启用远程控制",id:"akXG4ChYkN"'
        'defaultMessage:"Automatically connect new local sessions to Remote Control so you can continue them from the CLI or claude.ai/code.",id:"h3IJeFcbkv"' = 'defaultMessage:"自动将新的本地会话连接到远程控制，这样你就可以从 CLI 或 claude.ai/code 继续使用它们。",id:"h3IJeFcbkv"'
        'defaultMessage:"Size of the conversation transcript text.",id:"w1A4zeclNH"' = 'defaultMessage:"对话记录文本大小。",id:"w1A4zeclNH"'
        'defaultMessage:"When Claude pushes changes to a branch, it automatically opens a pull request without asking first. Applies to remote sessions only.",id:"nBQeVvSeP7"' = 'defaultMessage:"当 Claude 将更改推送到分支时，会自动打开拉取请求，而不会先询问。仅适用于远程会话。",id:"nBQeVvSeP7"'
        'defaultMessage:"Remote Control is disabled by your organization''s policy.",id:"geOrzylJdv"' = 'defaultMessage:"远程控制已被你的组织策略禁用。",id:"geOrzylJdv"'
        'defaultMessage:"Remote Control turned on.",id:"Dvf9VEg4i3"' = 'defaultMessage:"远程控制已开启。",id:"Dvf9VEg4i3"'
        'defaultMessage:"Remote Control turned off.",id:"TVdWaZSDJo"' = 'defaultMessage:"远程控制已关闭。",id:"TVdWaZSDJo"'
        'defaultMessage:"Remote Control disconnected",id:"SlaNB/mm2w"' = 'defaultMessage:"远程控制已断开连接",id:"SlaNB/mm2w"'
        'defaultMessage:"Set up Remote Control",id:"obP7mr2o1D"' = 'defaultMessage:"设置远程控制",id:"obP7mr2o1D"'
        'defaultMessage:"Worktree location",id:"cU7ff1IrXY"' = 'defaultMessage:"工作树位置",id:"cU7ff1IrXY"'
        'defaultMessage:"Where to store git worktrees for isolated coding sessions",id:"aaW9XOSy8a"' = 'defaultMessage:"用于存储隔离编码会话工作树的位置",id:"aaW9XOSy8a"'
        'defaultMessage:"Light code theme",id:"vikR8aVphg"' = 'defaultMessage:"浅色代码主题",id:"vikR8aVphg"'
        'defaultMessage:"Dark code theme",id:"s3+O5jyM3P"' = 'defaultMessage:"深色代码主题",id:"s3+O5jyM3P"'
        'defaultMessage:"Set a custom monospace font for code and terminal.",id:"eMV1kF66ej"' = 'defaultMessage:"为代码和终端设置自定义等宽字体。",id:"eMV1kF66ej"'
        'defaultMessage:"e.g. JetBrains Mono",id:"AmpQ4SI339"' = 'defaultMessage:"例如 JetBrains Mono",id:"AmpQ4SI339"'
...
function Unpatch-JsLanguage {
    ...
    $fallbackReplacements = [ordered]@{
        ...
        'defaultMessage:"新建会话",id:"Ajmo+3Cu3b"'    = 'defaultMessage:"New session",id:"Ajmo+3Cu3b"'
        'defaultMessage:"最近",id:"wA4FIMmtlS"'        = 'defaultMessage:"Recents",id:"wA4FIMmtlS"'
        'defaultMessage:"你启动的会话会显示在这里",id:"2QWN8hlND7"' = 'defaultMessage:"Sessions you start will show up here",id:"2QWN8hlND7"'
        'defaultMessage:"高",id:"AxMhQrcUDC"'           = 'defaultMessage:"High",id:"AxMhQrcUDC"'
        'defaultMessage:"高",id:"NqAztXFiG6"'           = 'defaultMessage:"High",id:"NqAztXFiG6"'
        'defaultMessage:"绕过权限",id:"PHx7oHc7eF"' = 'defaultMessage:"Bypass permissions",id:"PHx7oHc7eF"'
        'defaultMessage:"描述你想让 Code 做什么…",id:"n6hqGlQEYe"' = 'defaultMessage:"Describe what you want Code to do…",id:"n6hqGlQEYe"'
        'defaultMessage:"本地会话",id:"SKeCK+7hmh"' = 'defaultMessage:"Local sessions",id:"SKeCK+7hmh"'
        'defaultMessage:"默认启用远程控制",id:"akXG4ChYkN"' = 'defaultMessage:"Enable remote control by default",id:"akXG4ChYkN"'
        'defaultMessage:"自动将新的本地会话连接到远程控制，这样你就可以从 CLI 或 claude.ai/code 继续使用它们。",id:"h3IJeFcbkv"' = 'defaultMessage:"Automatically connect new local sessions to Remote Control so you can continue them from the CLI or claude.ai/code.",id:"h3IJeFcbkv"'
        'defaultMessage:"对话记录文本大小。",id:"w1A4zeclNH"' = 'defaultMessage:"Size of the conversation transcript text.",id:"w1A4zeclNH"'
        'defaultMessage:"当 Claude 将更改推送到分支时，会自动打开拉取请求，而不会先询问。仅适用于远程会话。",id:"nBQeVvSeP7"' = 'defaultMessage:"When Claude pushes changes to a branch, it automatically opens a pull request without asking first. Applies to remote sessions only.",id:"nBQeVvSeP7"'
        'defaultMessage:"远程控制已被你的组织策略禁用。",id:"geOrzylJdv"' = 'defaultMessage:"Remote Control is disabled by your organization''s policy.",id:"geOrzylJdv"'
        'defaultMessage:"远程控制已开启。",id:"Dvf9VEg4i3"' = 'defaultMessage:"Remote Control turned on.",id:"Dvf9VEg4i3"'
        'defaultMessage:"远程控制已关闭。",id:"TVdWaZSDJo"' = 'defaultMessage:"Remote Control turned off.",id:"TVdWaZSDJo"'
        'defaultMessage:"远程控制已断开连接",id:"SlaNB/mm2w"' = 'defaultMessage:"Remote Control disconnected",id:"SlaNB/mm2w"'
        'defaultMessage:"设置远程控制",id:"obP7mr2o1D"' = 'defaultMessage:"Set up Remote Control",id:"obP7mr2o1D"'
        'defaultMessage:"工作树位置",id:"cU7ff1IrXY"' = 'defaultMessage:"Worktree location",id:"cU7ff1IrXY"'
        'defaultMessage:"用于存储隔离编码会话工作树的位置",id:"aaW9XOSy8a"' = 'defaultMessage:"Where to store git worktrees for isolated coding sessions",id:"aaW9XOSy8a"'
        'defaultMessage:"浅色代码主题",id:"vikR8aVphg"' = 'defaultMessage:"Light code theme",id:"vikR8aVphg"'
        'defaultMessage:"深色代码主题",id:"s3+O5jyM3P"' = 'defaultMessage:"Dark code theme",id:"s3+O5jyM3P"'
        'defaultMessage:"为代码和终端设置自定义等宽字体。",id:"eMV1kF66ej"' = 'defaultMessage:"Set a custom monospace font for code and terminal.",id:"eMV1kF66ej"'
        'defaultMessage:"例如 JetBrains Mono",id:"AmpQ4SI339"' = 'defaultMessage:"e.g. JetBrains Mono",id:"AmpQ4SI339"'
